...
local function CreateUILibrary()
  ...
  local function CreateTab(name)
    ...
    TabContent.Size = UDim2.new(1, 0, 0, 0) -- Height will be set by AutomaticCanvasSize
    ...
    Button.MouseButton1Click:Connect(function()
      if CurrentActiveTab then
        ...
        CurrentActiveTab.Parent.Parent:FindFirstChild(CurrentActiveTab.Name:gsub("Content", "Button")).BackgroundColor3 =
